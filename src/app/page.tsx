                ...
                {blocks.map((block, index) => (
                    ...
                    >
                        <div style={innerCardStyle(hoveredIndex === index)}>
                            ...
                            <span style={hoverIndicatorStyle(hoveredIndex === index)}>&#8594;</span>
                        </div>
                    </Link>
                ))}
            </div>
...
const blocks = [
    { title: 'PNG to JPG', description: 'Convert PNG images to JPG format.', link: '/convert/png-to-jpg' },
    { title: 'JPG to PNG', description: 'Convert JPG images to PNG format.', link: '/convert/jpg-to-png' },
    { title: 'Resize Image', description: 'Change the dimensions of images.', link: '/resize-image' },
];
...
const innerCardStyle = (isHovered: boolean): CSSProperties => ({
    ...
    borderRadius: '12px',
    backgroundColor: '#fff',
    boxShadow: isHovered ? '0 12px 30px rgba(0, 0, 0, 0.2)' : '0 8px 15px rgba(0, 0, 0, 0.1)',
    textAlign: 'center',
    color: '#2d3142',
